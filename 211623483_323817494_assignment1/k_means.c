...
int main(int argc, char *argv[]) {
    ...
    centroids = init_centroids(points, K, dim);
    if (centroids == NULL) {
    ...
    kmeans(points, centroids, n_points, K, dim, max_iter, 1e-3);
